...
public class TotalLinks {
	...
	public static void main(String[] args) {
		...
		for(int i=0; i<linksList.size(); i++) {
			String text = linksList.get(i).getAttribute("href");
				if(!text.contains("/ie/en")) {
					System.out.println(i+ " : "+text+ " "+ "need to resolve");
				}
		}
		
		driver.get("https://www.angara.com/ie/en/c/rings");

		List<WebElement> links2List = driver.findElements(By.tagName("a"));
		System.out.println("total links: " + links2List.size());
